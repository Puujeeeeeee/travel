...
const Navbar = () => {
  ...
  const navLinks = [
    ...
    { href: "/product", label: "Аяллын брэндүүд" },
  ...
  return (
    <nav className="flexBetween w-full bg-gray-200 z-30 py-5 items-center sticky top-0">
      <div className="max-w-[2000px] w-full mx-auto px-6 flex justify-between">
        <Link href="/">
